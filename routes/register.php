...
<div id="bodySection">
    <div class="container">
        <div class="row align-items-center pt-5 text-center">
            <div class="col-md-12"><h3>NEW ADMINE</h3></div>
        </div>
        <div class="row py-4">
            <div class="col-md-12">
                <div id="regSection" class="text-center">
                    <form id="regForm" enctype="multipart/form-data">
                        ...
                        <div class="form-row py-1">
                            ...
                            <input onclick="regFun()" type="button" style="background-color:#9BCDD2" class="form-control btn btn-success" id="register" value="Register">
                            </div>
                            <div class="form-group col-md-3"></div>
                        </div>
                    </form>
